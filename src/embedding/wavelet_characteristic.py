...
if __name__ == "__main__":
    ...
    # ------------------
    # generate small weighted graphs
    # ------------------
    graphs = []
    num_graphs = 3
    num_nodes = 8
    ...
    # ------------------
    # initialize WaveletCharacteristic
    # ------------------
    ...
    final_embeddings = np.round(final_embeddings, 2)
